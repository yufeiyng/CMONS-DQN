classdef CMONS_DQN_HOA < ALGORITHM
    ...
    methods
        ...
        function main(Algorithm, Problem)
            ...
            while Algorithm.NotTerminated(Population1)
                ...
                % Generate offspring with HOA
                Offspring1 = OperatorHOA(Problem, Population1, Fitness1);
                Offspring2 = OperatorHOA(Problem, Population2, Fitness2);
